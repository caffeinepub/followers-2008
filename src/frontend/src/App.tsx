...
const UPI_QR_IMAGE =
  "/assets/uploads/img-20260328-wa0003-019d324a-7d9b-70bf-903c-d9f5e9ba4fff-2.jpg";
const UPI_ID = "8700910551@ptsbi";
const UPI_NAME = "Sunder Singh";
const ADMIN_PASSWORD = "admin2008";
const ORDERS_KEY = "followers2008_orders";
...
const pricingPlans: Plan[] = [
  {
    ...
    price: "\u20B9130",
    tag: null,
    productName: "Basic - 100 Instagram Followers",
    priceInPaise: 13000,
  },
  {
    title: "Starter",
...
export default function App() {
  ...
  const handleAdminLogin = () => {
    if (adminPassword === ADMIN_PASSWORD) {
      ...
      setAdminPasswordError("Wrong password. Try again.");
    }
  };
  ...
  const handleUpiPay = () => {
    if (!instagramHandle.trim()) {
      toast.error("Please enter your Instagram profile link.");
      return;
    }
  ...
  const handleSubmitOrder = (file: File | null) => {
    const saveOrder = (screenshotDataUrl: string) => {
      ...
      existingOrders.unshift({
        ...
        product: pendingPlan?.productName || "",
      ...
      toast.success("Order submitted! We'll deliver within 24 hours.");
    ...
    if (file) {
      ...
      reader.onload = (e) => saveOrder(e.target?.result as string);
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          >
            <div>
              ...
              >
                Followers 2008 — Order Management
              </p>
            </div>
            ...
            {orders.length === 0 ? (
              ...
              >
                ...
                <div style={{ fontSize: "0.9rem", marginTop: "0.4rem" }}>
                  Orders will appear here when customers pay via UPI.
                </div>
              </div>
            ) : (
                      ...
                      >
                        ...
                        <td style={{ padding: "0.7rem 0.9rem" }}>
                          {order.screenshot ? (
                            ...
                            <span
                              style={{ color: "#d1d5db", fontSize: "0.8rem" }}
                            >
                              —
                            </span>
                          )}
              ...
              >
                <button
                  ...
                  style={{
                    width: "100%",
                    padding: "0.85rem",
                    background: "linear-gradient(90deg, #00b9f1, #0070ba)",
                    color: "#fff",
                    border: "none",
                    borderRadius: 10,
                    fontSize: "1.05rem",
                ...
                >
                  ...
                  Pay {pendingPlan?.price} via UPI / Paytm
                </button>
                ...
                <button
                  ...
                  data-ocid="instagram.cancel_button"
                >
                  Cancel
                </button>
              </div>
      ...
      <AnimatePresence>
        {showUpiModal && (
          <motion.div
            ...
            onKeyDown={(e) => {
              if (e.key === "Escape") setShowUpiModal(false);
            }}
            data-ocid="upi.modal"
          >
            <motion.div
            ...
            >
              ...
              {pendingPlan && (
                ...
                >
                  {pendingPlan.productName} — {pendingPlan.price}
                  {instagramHandle && (
                    <span style={{ color: "#6b7280", fontWeight: 400 }}>
                      {" "}
                      &bull; {instagramHandle}
                    </span>
                  )}
                </div>
              )}
              ...
              <button
                type="button"
                onClick={() => handleSubmitOrder(screenshotFile)}
                style={{
                  width: "100%",
                  marginTop: "1rem",
                  padding: "0.8rem",
          ...
          >
            ...
            <div
              style={{
                background: "#fff",
                borderRadius: 24,
                boxShadow: "0 6px 40px rgba(37,99,235,0.12)",
                padding: "2.5rem 2rem",
                display: "inline-block",
                width: "100%",
                boxSizing: "border-box",
            ...
            >
              ...
              >
                <img
                  src={UPI_QR_IMAGE}
                  alt="Paytm UPI QR Code - Scan to Pay"
                  style={{
                    width: 240,
                    height: 240,
                    objectFit: "contain",
              ...
              >
                {["Paytm", "PhonePe", "GPay", "BHIM", "Any UPI"].map((app) => (
                  <span
                    key={app}
                    style={{
                      background: "#eff6ff",
              ...
              >
                ...
                <ol style={{ margin: "0.5rem 0 0", paddingLeft: "1.4rem" }}>
                  <li>
                    Select your package above and click &quot;Buy via UPI&quot;
                  </li>
                  <li>
                    Scan the QR code with Paytm, PhonePe, GPay, or any UPI app
                  </li>
                  <li>
                    Upload your payment screenshot and enter your Instagram
                    username on the website
                  </li>
                  <li>Followers will be delivered within 24 hours</li>
                </ol>
              </div>
              ...
              >
                Select your package above, scan to pay, then submit your
                screenshot and Instagram profile link on the website.
              </p>
            </div>
          </motion.div>
        </div>
